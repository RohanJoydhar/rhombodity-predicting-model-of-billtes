...
ggplot(dn,aes(heat_ext)) +geom_histogram(fill = "#9db2cf") + theme_linedraw() + labs(title="After normalized")
ggplot(dn,aes(x=heat_ext,y=dd)) +geom_point(color ="#9db2cf") + theme_linedraw()
